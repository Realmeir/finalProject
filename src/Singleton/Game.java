...
import Singleton.UserProfile;

import java.util.*;

public class Game {
    private ArrayList<Question> questionSet;
    public void notifyLanguageLevelChanged(UserProfile userProfile) {
        System.out.println("Ваш уровень языка был изменен в профиле: " + userProfile.getLanguageLevel());
    }
