import Singleton.UserManagerSingleton;
...
public class LanguageLearningApp {
    public static void main(String[] args) {
        ...
        System.out.println("EngBro - изучайте языки бесплатно, весело и эффективно!");// Displaying a welcome message
        System.out.println("Выберите действие: (1) Зарегистрироваться, (2) Войти");
        int actionChoice = scanner.nextInt();

        if (actionChoice == 1) {// Reading the user's action choice
